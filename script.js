...
const content = [
  { gif: 'https://i.pinimg.com/originals/7a/ef/73/7aef734a86dce4dc206976d4f0586f2c.gif', message: 'Tớ biết lỗi rồi mà 😢' },
  { gif: 'https://i.pinimg.com/originals/c8/07/e2/c807e26d8aed392f172f0bf441f60626.gif', message: 'Thử nghĩ lại nha 🥺' },
  { gif: 'https://i.pinimg.com/originals/0d/ac/7e/0dac7e14010362ff081e2167be218341.gif', message: 'Đừng mà Tâm, cho tớ cơ hội đi 💔' },
...
noBtn.addEventListener('click', () => {
  ...
  if (clickCount === 3) {
    noBtn.textContent = 'Bấm Đồng ý đi 😭';
  } else if (clickCount === 7) {
    noBtn.textContent = 'Năn nỉ đó bấm Đồng ý đi 😭';
  }
...
yesBtn.addEventListener('click', () => {
  question.textContent = 'Tớ cảm ơn cậu nhìu lắm! Tớ sẽ cố gắng thay đổi từng ngày để mình đi xa hơn! ❤️';
